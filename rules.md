...
## Main Commitment
### *I will code or design for at least an hour every day for the next 100 days.*

#### Start Date
July 4th, 2021

## Additional Rules
1. I will tweet about my progress (almost) every day, using the hashtag #100DaysOfCode
2. If I code for work, that time won't count towards the challenge.
3. If I have code that can be published, I will push it to GitHub every day so that anyone can see my progress.
4. I will update the (Log)[log.md] with the day's progress and provide a link so that others can see my progress.
5. I will work on real projects, facing real challenges. The time spent doing tutorials, online courses and other similar resources will NOT count towards this challenge. (If you've just started learning to code, read [FAQ](FAQ.md))
6. I will work on whatever is most important to me, whether that's UX/UI, web design, or web development. 
